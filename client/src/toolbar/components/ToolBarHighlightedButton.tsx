...
export const ToolBarHighlightedButton = ({ onClick, svg }: ToolBarHighlightedButtonProps) => {
    return (
        <div className="rounded-full group size-12 border-2 border-accent bg-elementBackground-1 shadow-md shadow-background flex justify-center items-center z-30">
