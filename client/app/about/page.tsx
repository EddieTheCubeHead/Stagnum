...
const AboutPage: React.FC = () => {
    return (
        ...
        >
            <Grid>
            <Image style={{ width: '100%', height: 500, objectFit: 'cover'}}
                    src={require('@/public/about1.jpg')}
                    alt={'About Stagnum'}
                />

            <Typography variant="h1" mt={4} mb={6} textAlign={'center'} 
             sx={{
                color: 'primary.main',
            }}>
                About Stagnum
            ...
            Stagnum has been designed to enhance Spotify listening experience using pool based playback for better song shuffles, and collaborative listening. 
            </Typography>
        ...
        >
            ...
            <Typography variant="h4" mt={15} textAlign={'center'} 
              sx={{
                color: 'primary.main',
            }}>
            ...
            <Typography variant="h4" textAlign={'center'}>
                This page serves as your one-stop guide for all you need to know about Stagnum.
            </Typography>
            </Grid>
            <Image  width={'50%'}
...
<Image  width={'50%'}
            ...
            To comply with Spotify’s guidelines, Stagnum can only be used by users with Spotify Premium. 
            </Typography>
            </Grid>
...
>
    Login with your Spotify Premium Account
            ...
            <Typography variant="h5" mb={6} textAlign={'center'} 
>
            Search for your favorite songs and add them to the pool
            </Typography>
            </Grid>
