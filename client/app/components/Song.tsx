  ...
  return (
    <div className="flex gap-8 w-full items-center">
      <div
        ...
        className="grid grid-cols-2 text-neutral-400 text-sm py-4 px-5 hover:bg-white hover:bg-opacity-10 rounded-lg cursor-default w-full"
      >
      ...
      <div className="flex flex-col relative w-6">
        <EllipsisHorizontalCircleIcon
          onClick={() => setPopup(!popup)}
          className="cursor-pointer"
        />
        <button
          className={`absolute px-4 py-2 rounded-lg text-red-700 bg-white object-contain top-8 right-0 w-48 ${
            popup ? "flex" : "hidden"
          }`}
        >
          Remove From Pool
