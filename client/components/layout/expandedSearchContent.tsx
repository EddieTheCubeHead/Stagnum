        ...
        <Stack sx={{ padding: 1, width: 1 }}>
            ...
            <Box sx={{
                ...
                {props.trackList.slice(0, 2).map((track, key) => (
                    <TrackCard key={key} track={track} updatePool={props.updatePool} token={props.token} disabled={props.disabled} enableAddButton={props.enableAddButton} />
                ))}
            </Box>
            <Box sx={{
                margin: 1,
            ...
            <Box sx={{
                ...
                {props.albumList.slice(0, 2).map((album, key) => (
                    <AlbumCard key={key} album={album} updatePool={props.updatePool} token={props.token} disabled={props.disabled} enableAddButton={props.enableAddButton} />
                ))}
            </Box>
            <Box sx={{
                margin: 1,
            ...
            <Box sx={{
                ...
                {props.playlistList.slice(0, 2).map((playlist, key) => (
                    <PlaylistCard key={key} playlist={playlist} updatePool={props.updatePool} token={props.token} disabled={props.disabled} enableAddButton={props.enableAddButton} />
                ))}
            </Box>
            <Box sx={{
                margin: 1,
            ...
            <Box sx={{
                ...
                {props.artistList.slice(0, 2).map((artist, key) => (
                    <ArtistCard key={key} artist={artist} updatePool={props.updatePool} token={props.token} disabled={props.disabled} enableAddButton={props.enableAddButton} />
                ))}
            </Box>
            <Box sx={{
                margin: 1,
