...
export const ToolBarOpenedField = ({ onClick, action, svg }: ToolBarOpenedFieldProps) => {
    ...
    return (
        <div className="rounded-full border flex border-accent h-8 bg-elementBackground-3 placeholder-clickable text-stroke w-56 items-center z-20 pl-3 pr-1 focus:outline-none has-[:focus]:ring-1 has-[:focus]:ring-accent-purple peer shadow-xl shadow-background">
            {action}
