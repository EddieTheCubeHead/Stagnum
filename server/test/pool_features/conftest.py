...
@pytest.fixture
def create_playback(db_connection: ConnectionManager, create_mock_track_search_result: MockTrackSearchResult,
                    ...
                    validate_response: ValidateResponse) -> CreatePlayback:
