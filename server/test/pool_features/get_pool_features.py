...
from test_types.callables import ValidateResponse, AssertTokenInHeaders, CreatePool, ValidateErrorResponse, \
    ValidateModel
from test_types.typed_dictionaries import Headers


def should_get_all_existing_tracks(existing_pool: list[PoolMember], test_client: TestClient,
                                   valid_token_header: Headers, validate_model: ValidateModel):
...
def should_return_mix_of_tracks_and_collections_correctly(create_pool: CreatePool, test_client: TestClient,
                                                          valid_token_header: Headers, validate_model: ValidateModel):
    track_amount = 25
