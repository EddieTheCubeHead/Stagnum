...
def should_get_twenty_playlists_by_default(test_client, valid_token_header, validate_response, requests_client,
                                           validate_paginated_result_length, create_playlist_paginated_search):
    query = "my query"
...
def should_query_spotify_for_playlists_with_provided_query_string(test_client, valid_token_header, requests_client,
                                                                  create_playlist_paginated_search):
    query = "my query"
    requests_client.get = Mock(return_value=create_playlist_paginated_search(query))
...
def should_use_offset_and_limit_if_provided(test_client, valid_token_header, requests_client,
                                            create_playlist_paginated_search, validate_response,
